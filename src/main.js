...
/** Currently active settings drawer. */
...
async function init() {
  ...
  function openSettings() {
    ...
    if (activeProfileDrawer) {
      const d = activeProfileDrawer; activeProfileDrawer = null; d.destroy();
    }

    // Save and hide main area content
