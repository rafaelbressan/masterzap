  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        { text: 'As mensagens também revelam que Vorcaro chamou o ex-presidente Bolsonaro de "idiota" após uma postagem sobre o Banco Master, e descreveu André Esteves, do BTG Pactual, com termos como "ardiloso" e "cínico". Os diálogos íntimos do casal {viralizaram nas redes sociais}[https://ndmais.com.br/justica/vorcaro-momolada-peleleca-conversas-martha-graeff/] por conta da linguagem afetiva com apelidos como "momolada" e "{peleleca}[action:search:peleleca]", que dominaram a internet. O casal também usava frequentemente a palavra "{amor}[action:search:amor]" — presente em mais de 11 mil mensagens.' },
      ],
    },
    {
